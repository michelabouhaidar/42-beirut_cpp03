...
/*   Updated: 2025/09/25 18:54:30 by mabou-ha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "ClapTrap " << obj.name_ << " copy constructor called" << std::endl;
...
void ClapTrap::setPoints(const int pts)
{
	pts_ = pts;
}

void ClapTrap::setEnergyPoints(const int pts)
{
	nrg_pts_ = pts;
}

void ClapTrap::setAttackPoints(const int pts)
{
	nrg_pts_ = pts;
}
